...
> 生成：2026-09-19T15:57:55.840Z　｜　执行器：`node e2e/acceptance.mjs`
...
| 结果 | 套件 | 事实 |
|---|---|---|
| ✅ PASS | 服务端单测 | tests=1893　pass=1892　fail=0　skipped=1 |
...
| ❌ FAIL | CRS 执行器保真度（官方回归集） | 保真度=96%　未点名分歧=23　已消失=0　误触=4 |
...
**汇总：11 PASS / 1 FAIL(含 BLOCKED) / 0 SKIP**

## 失败详情
- **CRS 执行器保真度（官方回归集）**：出现 23 条未点名分歧（看 e2e/waf-real/crs-equivalence.md）
