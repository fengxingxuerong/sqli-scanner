// 空格 → SQL 行注释 #：将空格替换为 SQL 行注释 #（对标 sqlmap space2sqlcomment.py）
export const space2sqlcomment = {
  name: 'space2sqlcomment',
  description: '将空格替换为 SQL 行注释 #，绕过 WAF 空格过滤（引号保护）',
...
export default space2sqlcomment;