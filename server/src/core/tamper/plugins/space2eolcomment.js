// 空格 → 行尾注释：将空格替换为行尾注释 -- （对标 sqlmap space2eolcomment.py）
export const space2eolcomment = {
  name: 'space2eolcomment',
  description: '将空格替换为行尾注释 --，绕过 WAF 空格过滤（引号保护）',
  /**
...
export default space2eolcomment;
