// 空格 → 分号：将空格替换为分号 ;（对标 sqlmap space2semicolon.py）
export const space2semicolon = {
  name: 'space2semicolon',
  description: '将空格替换为分号 ;，绕过 WAF 空格过滤（引号保护）',
  /**
...
export default space2semicolon;
