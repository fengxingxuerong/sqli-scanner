// 空格 → 反斜杠：将空格替换为反斜杠（对标 sqlmap space2backslash.py）
export const space2backslash = {
  name: 'space2backslash',
  description: '将空格替换为反斜杠 \\，绕过 WAF 空格过滤（引号保护）',
...
export default space2backslash;