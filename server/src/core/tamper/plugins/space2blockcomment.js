// 空格 → MySQL 条件注释：将空格替换为 /*! 注释 */（对标 sqlmap space2blockcomment.py）
// MySQL 条件注释内的语句仍会被执行
export const space2blockcomment = {
  name: 'space2blockcomment',
  description: '将空格替换为 MySQL 条件注释 /*! */，绕过 WAF 空格过滤（引号保护）',
  /**
...
export default space2blockcomment;
