// 空格 → & 符号：将空格替换为 & 符号（对标 sqlmap space2ampersand.py）
export const space2ampersand = {
  name: 'space2ampersand',
  description: '将空格替换为 & 符号，绕过 WAF 空格过滤（引号保护）',
  /**
...
export default space2ampersand;
