...
[![Tests](https://img.shields.io/badge/tests-2340%20passing-brightgreen)](#测试)
...
- 服务端测试: 2026 用例（2025 pass / 0 fail / 1 skip，并发口径 2026-09-20 复测；1 skip 为环境依赖显式跳过。覆盖率 lines 89.47 / branch 73.68 / func 76.68，阈值 85/69/72）
