...
[![Tests](https://img.shields.io/badge/tests-2434%20passing-brightgreen)](#测试)
...
- 服务端测试: 2119 用例（2116 pass / 0 fail / 3 skip，并发口径 2026-09-22 复测；3 skip 为环境依赖显式跳过。覆盖率 lines 89.66 / branch 74.03 / func 77.48，阈值 85/69/72）
