...
[![Tests](https://img.shields.io/badge/tests-2422%20passing-brightgreen)](#测试)
...
- 服务端测试: 2110 用例（2107 pass / 0 fail / 3 skip，并发口径 2026-09-21 复测；3 skip 为环境依赖显式跳过。覆盖率 lines 89.55 / branch 74.08 / func 76.95，阈值 85/69/72）
