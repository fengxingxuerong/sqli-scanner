...
[![Tests](https://img.shields.io/badge/tests-2479%20passing-brightgreen)](#测试)
...
- 服务端测试: 2164 用例（2161 pass / 0 fail / 3 skip，并发口径 2026-09-22 复测；3 skip 为环境依赖显式跳过。覆盖率 lines 89.88 / branch 74.34 / func 78.68，阈值 85/69/72）
