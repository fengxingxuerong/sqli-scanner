...
[![Tests](https://img.shields.io/badge/tests-2501%20passing-brightgreen)](#测试)
...
- 服务端测试: 2186 用例（2183 pass / 0 fail / 3 skip，并发口径 2026-09-22 复测；3 skip 为环境依赖显式跳过。覆盖率 lines 90.04 / branch 76.88 / func 79.06，阈值 85/69/72）
