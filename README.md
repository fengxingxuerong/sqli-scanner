...
[![Tests](https://img.shields.io/badge/tests-2491%20passing-brightgreen)](#测试)
...
- 服务端测试: 2176 用例（2173 pass / 0 fail / 3 skip，并发口径 2026-09-22 复测；3 skip 为环境依赖显式跳过。覆盖率 lines 89.90 / branch 76.73 / func 78.69，阈值 85/69/72）
