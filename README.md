...
[![Tests](https://img.shields.io/badge/tests-2465%20passing-brightgreen)](#测试)
...
- 服务端测试: 2150 用例（2147 pass / 0 fail / 3 skip，并发口径 2026-09-22 复测；3 skip 为环境依赖显式跳过。覆盖率 lines 89.72 / branch 74.21 / func 78.27，阈值 85/69/72）
